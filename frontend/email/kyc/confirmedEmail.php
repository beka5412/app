TITLE=<?= lang($locale, 'KYC confirmed') . "\n" ?>
SUBJECT=<?= '[platform] - ' . lang($locale, 'Your identity has been verified.') ?>
                            ...
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">
                                        <?= lang($locale, 'Your identity has been successfully verified.') ?>
                                        <?= lang($locale, 'Now you can start using your account normally.') ?>
                                    </p>
