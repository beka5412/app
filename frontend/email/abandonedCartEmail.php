            ...
            <tbody>
              <tr>
                <td style="padding: 30px 30px 20px">
                    ...
                    Olá <?php echo $name; ?>, tudo bem? 
                    </p>
                    <p style="margin-bottom: 10px;">Vimos que você tem interesse no <?php echo $product->name; ?> e talvez você tenha ficado com alguma dúvida para concluir sua compra.</p>
                    <p style="margin-bottom: 10px;">Caso você queira continuar de onde parou, já vou deixar o link para você aqui: </p>
                    <p style="margin-bottom: 10px;">
                        <b><a href="<?php echo $url; ?>">clique aqui</a></b>.
                    </p>
                    ...
                    <p style="margin-bottom: 10px;">Lembrando que o seu RISCO É ZERO, e caso não goste, você tem até <?php echo $warranty_time; ?> dias para pedir o seu reembolso!</p>
                  ...
                  <p style="margin-bottom: 15px;">Este é um e-mail automático e não deve ser respondido, caso precise de
                    ajuda, <a style="color: #6576ff; text-decoration:none;" href="https://rocketpays.app">Clique
