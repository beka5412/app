                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <b>Cancelado</b>
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Seu pedido foi cancelado</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px; font-size: 18px;">Olá <?php echo $customer->name; ?></p>
                                    <p>Temos um pequeno contratempo a resolver. Infelizmente, o pagamento com o seu cartão de crédito foi recusado. 😔

                                        Mas não se preocupe, estamos aqui para ajudar! Acesse nosso site e atualize suas informações de pagamento. Isso geralmente resolve problemas de recusa de pagamento.

                                        Às vezes, as recusas de pagamento ocorrem por motivos como:

                                        *Limite insuficiente:* Verifique se há saldo disponível no cartão.

                                        *Dados incorretos:* Certifique-se de que as informações do cartão estejam corretas.

                                        *Cartão vencido:* Verifique a data de validade do cartão.

                                        *Bloqueio do banco:* Às vezes, o banco emissor bloqueia transações por segurança.

                                        Estamos aqui para tornar tudo fácil e rápido para você. Assim que atualizar seus dados, poderemos processar o pagamento e liberar seu acesso.
