TITLE=<?= lang($locale, 'Attention admin') . "\n" ?>
SUBJECT=<?= '[platform] - '.lang($locale, 'New withdrawal requires approval') ?>
              ...
              <tr>
                <td style="padding: 30px 30px 20px">
                  <p style="margin-bottom: 10px; font-size: 18px;">
                    <?= lang($locale, 'Hello') ?>! 
                    <?= lang($locale, 'There is a new withdrawal on the platform that needs your attention to check whether or not it should be approved.') ?>
                  </p>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding:0 24px 0 24px;" bgcolor="#fffbcc">
                          ...
                          <p style="color:#5d5d4b;font-size:14px;line-height:undefined;margin:12px 0 12px 0">
                            <strong><?= lang($locale, 'Amount (raw)') ?>:</strong>
                            [amount]
                          </p>
                          <p style="color:#5d5d4b;font-size:14px;line-height:undefined;margin:0 0 12px 0">
                            <strong><?= lang($locale, 'Amount (with fees)') ?>:</strong>
                            [amount_with_fee]
                          </p>
                          <p style="color:#5d5d4b;font-size:14px;line-height:undefined;margin:0 0 12px 0">
                            <strong><?= lang($locale, 'Fee') ?>:</strong>
                            [fee]
                          </p>
                          <p style="color:#5d5d4b;font-size:14px;line-height:undefined;margin:0 0 12px 0">
                            <strong>Email:</strong>
