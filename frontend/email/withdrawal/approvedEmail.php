TITLE=<?= lang($locale, 'Withdrawal made') . "\n" ?>
SUBJECT=<?= '[platform] - ' . lang($locale, 'Your withdrawal request has been fulfilled.') ?>
                            ...
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">
                                        <?= lang($locale, 'Your withdrawal worth [amount] has been completed successfully.') ?>
                                    </p>
