TITLE=<?= lang($locale, 'Withdrawal canceled') . "\n" ?>
SUBJECT=<?= '[platform] - ' . lang($locale, 'Your withdrawal request has been canceled.') ?>
                            ...
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">
                                        <?= lang($locale, 'Unfortunately, we were unable to proceed with your withdrawal request.') ?>
                                        <?= lang($locale, 'Please contact support for more information.') ?>
                                    </p>
