...
SUBJECT=<?= '[platform] - '.lang($locale, 'New product requires approval') ?>
              ...
              <tr>
                <td style="padding: 30px 30px 20px">
                  <p style="margin-bottom: 10px; font-size: 18px;">
                    <?= lang($locale, 'Hello') ?>! <?= lang($locale, 'There is a new product on the platform that needs your attention to check whether or not it should be approved.') ?>
                  </p>
