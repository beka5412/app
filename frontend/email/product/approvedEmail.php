TITLE=<?= lang($locale, 'Approved product') . "\n" ?>
SUBJECT=<?= '[platform] - ' . lang($locale, 'The product [product_name] has been approved!') ?>
                            ...
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">
                                        <?= lang($locale, 'We have good news! We approve your product for sale.') ?>
                                    </p>

                                    <p style="margin-bottom: 10px;">
                                        <?= lang($locale, 'Now you can start selling the product [product_name] on our platform.') ?>
                                    </p>
