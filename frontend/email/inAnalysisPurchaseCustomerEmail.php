                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 15px 30px;">
                                    <b>Em análise</b>
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Seu pedido está em análise</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px; font-size: 18px;">Olá <?php echo $customer->name; ?></p>
                                    <p>Parabéns, sua compra está em análise! Confira os detalhes do seu pedido:
