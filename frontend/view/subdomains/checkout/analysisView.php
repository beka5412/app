...
<content>
  ...
  <div class="nk-block-content nk-error-ld text-center">
    ...
    <h3 class="nk-error-title">Pagamento em anlálise</h3>
      <p class="nk-error-text">Seu pedido <?php echo $product->name ?? ''; ?> está sendo processado e, após a aprovação do pagamento, será confirmado.</p>
      ...
      <!-- <a href="/demo1/index.html" class="btn btn-lg btn-primary mt-2">Acessar Painel</a> -->
