              ...
              <div class="card card-bordered">
                <div class="card-inner">
                  ...
                  <div>
                    ...
                    /* STEP: PAYMENT METHOD */
                    <div>
                      <div class="card-title d-flex mb-4 mt-2">
                      ...
                      <div class="">
                        ...
                        <div class="cart-resume1" data-summary-product-id="<?php echo $orderbump->product->id; ?>">
                         
                            <div class="desc-pay d-flex">
                              <?php echo $orderbump->product->name; ?>
                            </div>
                            <div id="descontoDe" style="text-align: end; color: #a5a5a5;">
                              R$ <?php echo number_format(doubleval($orderbump->price_promo ?: $orderbump->price ?: $orderbump->product->price_promo ?: $orderbump->product->price), 2, ',', '.'); ?>
                            </div>
                      ...
                      type="button" class="mt-1 w-100 btn-success mt-4">Finalizar compra
                        ...
                        <div class="alert alert-success alert-icon mt-4"><em class="icon ni ni-lock-alt"></em> Este é
                          um <strong>pagamento 100% seguro criptografado com SSL</strong>.
                        </div>
          ...
          <div class="col-lg-4">
            <div class="wide-sm">
              ...
              /** ***************************************************************
                  ...
                  *
                  **************************************************************** */
                   <center><img src="https://rocketpays.app/images/s.png"></center> 
            </div>
          </div>
          /* Fim segunda coluna */
