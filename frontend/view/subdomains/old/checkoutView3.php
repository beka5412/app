              ...
              <div class="card sckt-card">                    
                   /* STEP: PAYMENT METHOD */
                    <div class="card-inner">
                      ...
                      <div class="w-100" checkout-radio="payment-method" style="margin: 0; <?php if ($product->is_free): ?> display: none; <?php endif; ?>">
                        <div class="w-100" style="padding:0; display: <?php if ($product->credit_card_enabled): ?>block<?php else: ?>none<?php endif; ?>;">
                        ...
                        <div class="w-100" style="padding:0; display: <?php if ($product->pix_enabled): ?>block<?php else: ?>none<?php endif; ?>;">
                        ...
                        <div class="w-100" style="padding:0; display: <?php if ($product->billet_enabled): ?>block<?php else: ?>none<?php endif; ?>;">
                          <div class="custom-control custom-checkbox custom-control-pro no-control w-100" 
                            style="padding: 2px;">
                            <input 
                                  /* Usados no JavaScript */
                        ...
                        <div class="w-100" style="padding: 0; display: none">
