...
<content ready="ready">
    <div id="app" class="app"><content ready="ready">
                ...
                <div id="footerdashboard1">
                    <div>
                        <div id="vendasgerais" class="mt-4">
                            <h1><span class="text-gradient">Seja bem-vindo</span></h1>
                                    ...
                                    <div id="tas4">
                                        <div class="metric-item">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Total em vendas</p>
                                                <p id="vendashoje" style="opacity: 1;" class="metric-number-aprovadas">R$ <?php echo number_format($statistics['order_amount'], 2, ",", ".");  ?></p>
                                            </div>
                                        </div>
                                        <div class="metric-item">
                                            <div class="metric-header">
                                            ...
                                            <div class="metric-content">
                                                ...
                                                <p id="vendashoje" style="opacity: 1;" class="metric-number-aprovadas">R$ <?php echo number_format($statistics['sales_today'], 2, ",", ".");  ?></p>
                                            </div>
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Faturamento total</p>
                                                <p id="saldodisponivel" style="opacity: 1;" class="metric-number-saldodisponivel">R$ <?php echo number_format($statistics['revenue'], 2, ",", ".");  ?></p>
                                            </div>
                                        </div>
                                        <div class="metric-item">
                                            <div class="metric-header">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Taxas Gateway</p>
                                                <p class="metric-number-conversao">R$ <?php echo number_format($statistics['gateway_tax'], 2, ",", ".");  ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="main3396">
                                    <div id="tas4">
                                        <div class="metric-item">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Usúarios</p>
                                                <p id="vendashoje" style="opacity: 1;" class="metric-number-aprovadas"><?php echo $statistics['total_users']; ?></p>
                                            </div>
                                        </div>
                                        <div class="metric-item">
                                            <div class="metric-header">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Novos Usúarios</p>
                                                <p id="vendashoje" style="opacity: 1;" class="metric-number-aprovadas"><?php echo $statistics['last_users'] ?></p>
                                            </div>
                                        </div><div class="metric-item">
                                            <div class="metric-header">
                                                <img alt="icon" src="/images/dashboard/Featured icon2.png" class="featured-icon">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Quantidade de pedidos</p>
                                                <p id="saldodisponivel" style="opacity: 1;" class="metric-number-saldodisponivel"><?php echo $statistics['order_count']; ?></p>
                                            </div>
                                        </div>
                                        <div class="metric-item">
                                            <div class="metric-header">
                                            ...
                                            <div class="metric-content">
                                                <p class="vendashojecss">Ticket Médio</p>
                                                <p class="metric-number-conversao"><?php echo number_format($statistics['sales_average'], 2, ",", ".");  ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div><div class="main3400">
                            <div class="main3395">
                                <div class="relatorio">
                                            ...
                                            <div class="p-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="" id="dashboardSelectProduct" class="form-control">
                                                        <option value="296">Downsell</option>
                                                        <option value="295">Upsell</option>
                                                        <option value="273">Produto teste</option>
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <label for="" class="form-label">Período</label>
                                                    <input type="text" id="date-picker" class="form-select form-control float-filters-data-picker flatpickr-input" placeholder="Selecionar intervalo" readonly="readonly">
                                                </div>
                                    ...
                                    <canvas class="my-4 w-100" id="myChart" width="1576" height="665" style="display: block; box-sizing: border-box; height: 665px; width: 1576px;"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
