    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
          <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Popups
          </div>
          <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <a  href="javascript:void(0);" to="<?php echo site_url(); ?>/popup/new" class="toggle btn btn-icon btn-primary d-md-none">
                    <em class="icon ni ni-plus"></em>
                </a>
                <a href="javascript:void(0);" to="<?php echo site_url(); ?>/popup/new" class="toggle btn btn-primary d-none d-md-inline-flex">
                    <em class="icon ni ni-plus"></em>
                    <span>Cadastrar Popup</span>
                </a>
            </div>
          </div>
        </div>
  ...
  <div class="nk-block">
    <div class="nk-tb-list is-separate mb-3">
      ...
      <div class="nk-tb-item tr">
        ...
        <div class="nk-tb-col tb-col-sm">
          <a href="<?php echo site_url(); ?>/popup/<?php echo $popup->id; ?>/edit" to="<?php echo site_url(); ?>/popup/<?php echo $popup->id; ?>/edit" class="tb-product">
            <span class="title"> <?php echo $popup->name; ?></span>
          </a>
        </div>
        <div class="nk-tb-col">
        ...
        <div class="nk-tb-col tb-col-md">
          <span class="tb-lead"><?php echo $popup->name ?? ''; ?></span>
        </div>
        <div class="nk-tb-col tb-col-md">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <ul class="link-list-opt no-bdr">
                    <li>
                      <a href="<?php echo site_url(); ?>/popup/<?php echo $popup->id; ?>/edit" 
                         to="<?php echo site_url(); ?>/popup/<?php echo $popup->id; ?>/edit">
                        <em class="icon ni ni-edit"></em>
                        <span>Editar</span>
                      </a>
                    </li>
                    <li>
                      <a href="javascript:;" click="popupDestroy" data-id="<?php echo $popup->id; ?>">
