<?php use Backend\Enums\Product\{EProductWarrantyTime, EProductType, EProductPaymentType, EProductDelivery}; ?>
    ...
    <div class="nk-block nk-block-middle wide-md mx-auto">
      <div class="nk-block-content nk-error-ld text-center">
        ...
        <div class="wide-xs mx-auto">
          <h3 class="nk-error-title">Não há Produtos Cadastrados! : (</h3>
          <p class="nk-error-text">Você pode criar e gerenciár ses produtos por aqui. </p>
      ...
      <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
          <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Produtos que sou afiliado
            </h3>
          </div>
          <div class="nk-block-head-content">
                  ...
                  <div class="nk-tb-item tr">
                    ...
                    <div class="nk-tb-col">
                      <span class="tb-product">
                        ...
                        <a to="<?php echo site_url(); ?>/aff/product/<?php echo $product->id; ?>" href="<?php echo site_url(); ?>/product/<?php echo $product->id; ?>">
                    ...
                    <div class="nk-tb-col tb-col-md">
                      <a href="<?= get_subdomain_serialized('checkout') ?>/<?php echo $product->defaultCheckout()?->sku ?: $product->sku; ?>" target="_blank">
            ...
            <div class="nk-modal-text">
              ...
              <div class="form-control-wrap">
                <select class="form-select inp_product_type">
                  <option value="<?php echo EProductType::DIGITAL->value; ?>">Digital</option>
