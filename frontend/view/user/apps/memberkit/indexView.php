        ...
        <div class="nk-block nk-block-middle wide-md mx-auto">
            <div class="nk-block-content nk-error-ld text-center">
                ...
                <div class="wide-xs mx-auto">
                    ...
                    <a href="javascript:void(0);" to="<?php echo site_url(); ?>/app/memberkit/new" class="toggle btn btn-primary d-none d-md-inline-flex">Cadastrar nova integração</a>
                </div>
            </div>
        </div>
    <?php else: ?>
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Integrações da Memberkit
                        </h3>
                    </div>
                    <div class="nk-block-head-content">
                        <div class="toggle-wrap nk-block-tools-toggle">
                            ...
                            <a to="<?php echo site_url(); ?>/app/memberkit/new" to="<?php echo site_url(); ?>/app/memberkit/new" class="toggle btn btn-icon btn-primary d-md-none">
                                <em class="icon ni ni-plus"></em>
                            </a>
                            <a to="<?php echo site_url(); ?>/app/memberkit/new" to="<?php echo site_url(); ?>/app/memberkit/new" class="toggle btn btn-primary d-none d-md-inline-flex">
                                <em class="icon ni ni-plus"></em>
                                <span>Adicionar</span>
                            </a>
                        </div>
                            ...
                            <div class="nk-tb-list is-separate mb-3">
                                ...
                                <?php foreach ($integrations as $integration): ?>
                                    <div class="nk-tb-item tr">
                                        ...
                                        <div class="nk-tb-col">
                                            <a href="<?php echo site_url(); ?>/app/memberkit/<?php echo $integration->id; ?>/edit" 
                                                to="<?php echo site_url(); ?>/app/memberkit/<?php echo $integration->id; ?>/edit" 
                                                class="tb-product">
                                                <span class="title">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a href="<?php echo site_url(); ?>/app/memberkit/<?php echo $integration->id; ?>/edit" to="<?php echo site_url(); ?>/app/memberkit/<?php echo $integration->id; ?>/edit">
                                                                        <em class="icon ni ni-edit"></em>
                                                                        <span>Editar</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" click="destroyMemberkitIntegration" data-id="<?php echo $integration->id; ?>">
