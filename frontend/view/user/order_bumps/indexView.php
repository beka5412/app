...
<content>
    <!-- tabela vazia -->
  <?php if ((json_decode(json_encode($orderbumps))->total ?? 0) == 0): ?>
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                      <div class="nk-block-content nk-error-ld text-center">
                        <center>
                        <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script> <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_n9sdhnrk.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
                        </center>
                        <div class="wide-xs mx-auto">
                          <h3 class="nk-error-title">Não há Nenhum OrderBump! : (</h3>
                          <p class="nk-error-text">você pode cadastrar um novo e gerenciá-los por aqui. </p>
                         
                          <a href="javascript:void(0);" to="<?php echo site_url(); ?>/orderbump/new" class="toggle btn btn-primary d-none d-md-inline-flex">
                      <em class="icon ni ni-plus"></em>
                      <span>Cadastrar OrderBump</span>
                    </a>
                        </div>
                      </div>
                    </div>
    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
          <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">OrderBump
          </div>
          <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
               <a  href="javascript:void(0);" to="<?php echo site_url(); ?>/orderbump/new" class="toggle btn btn-icon btn-primary d-md-none">
                  <em class="icon ni ni-plus"></em>
               </a>
               <a href="javascript:void(0);" to="<?php echo site_url(); ?>/orderbump/new" class="toggle btn btn-primary d-none d-md-inline-flex">
                  <em class="icon ni ni-plus"></em>
          ...
          <div class="card-inner p-0">
            <div class="nk-tb-list is-separate mb-3">
              <div class="nk-tb-item nk-tb-head">
                ...
                <div class="nk-tb-col">
                  <span>Nome do OrderBump </span>
                </div>
                <div class="nk-tb-col">
                  <span>Valor da oferta</span>
                </div>
                <div class="nk-tb-col tb-col-md">
                  <span>Produto Oferecido</span>
                </div>
                <div class="nk-tb-col tb-col-md">
              ...
              <div class="nk-tb-item tr">
                ...
                <div class="nk-tb-col">
                <a href="<?php echo site_url(); ?>/orderbump/<?php echo $orderbump->id; ?>/edit">
                    <span><?php echo $orderbump->name; ?></span>
                  </a>
                </div>
                <div class="nk-tb-col">
                  <span class="tb-lead">R$ <?php echo number_format($orderbump->price, 2, ',', '.'); ?></span>
                </div>
                <div class="nk-tb-col tb-col-md">
                  <span class="tb-lead"><?php echo $orderbump->product->name ?? ''; ?></span>
                  
                </div>
                <div class="nk-tb-col tb-col-md">
                  <span class="tb-lead"> <?php echo $orderbump->product_as_checkout_id ?? ''; ?></span>
                </div>
                <div class="nk-tb-col tb-col-md">
                  <?php if ($orderbump->status == \Backend\Enums\Orderbump\EOrderbumpStatus::PUBLISHED->value){ ?>
                    <span class="badge badge-sm badge-dot has-bg bg-success d-sm-inline-flex">Ativo</span>
                    <?php } else { ?>
                    <span class="badge badge-sm badge-dot has-bg bg-danger d-none d-sm-inline-flex">Desativado</span>
                  <?php }  ?>
                </div>
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                          <ul class="link-list-opt no-bdr">
                            <li>
                              <a href="<?php echo site_url(); ?>/orderbump/<?php echo $orderbump->id; ?>/edit" to="<?php echo site_url(); ?>/orderbump/<?php echo $orderbump->id; ?>/edit">
                                <em class="icon ni ni-edit"></em>
                                <span>Editar</span>
                              </a>
                            </li>
                            <li>
                              <a href="javascript:void(0);" click="orderbumpDestroy" data-id="<?php echo $orderbump->id; ?>">
