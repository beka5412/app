...
<head>
  ...
  <link rel="stylesheet" href="/static/css/purchase.css?v=<?php echo uniqid(); ?>">
  <?php echo $css; ?>
  <style>.swal2-container { z-index: 999999 }</style>
</head>

<body class="nk-body bg-dark npc-general is-dark has-sidebar">
