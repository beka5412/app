...
class ChargeFailed
{
    ...
    public function response()
    {
        ...
        if ($order->status_details === EOrderStatusDetail::REJECTED->value)
            return StripeWebhookQueue::response($entity, new ResponseData(['status' => 'error', 'message' => 'This order has already been rejected.']), new ResponseStatus('200 OK'));
