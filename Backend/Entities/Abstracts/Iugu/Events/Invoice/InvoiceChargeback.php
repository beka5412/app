...
class InvoiceChargeback
{
    public function response(Request $request)
    {
        ...
        if ($balance)
        {
            $chargeback_fee = doubleval(get_setting('chargeback_fee_price')) * doubleval(get_setting('usd_brl'));
            $balance->available -= $chargeback_fee;
            $balance->save();
            ...
            $balance_history->amount = $chargeback_fee;
