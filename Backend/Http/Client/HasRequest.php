...
trait HasRequest
{
    public function request(string $verb, string $url, array $headers = [], string $body = '', int $timeout=0, bool $return_header=false): object
    {
        ...
        return (object) [
            ...
            "time" => $time,
            "body" => $response,
            "json" => json_decode(gettype($response) == 'string' ? $response : '{}'),
        ];
    }
}