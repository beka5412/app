...
namespace Backend\Controllers\User\Product\Affiliation\Product\Support;
...
class IndexController
{
    ...
    public function __construct(App $application)
    {
        ...
        $this->indexFile = 'frontend/view/user/products/affiliation/products/support/indexView.php';
        $this->user = user();
    }
