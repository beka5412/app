...
class AnalysisController
{
    ...
    public function __construct(App $application)
    {
        ...
        $this->title = 'Checkout';
        $this->context = 'public';
        $this->indexFile = 'frontend/view/subdomains/checkout/analysisView.php';
        $this->user = user();
    ...
    public function index(Request $request)
    {
        ...
        View::render($this->indexFile, compact('title', 'context', 'user', 'id', 'order'));
    }
    ...
    public function element(Request $request)
    {
        ...
        $id = $request->query('id');
        $order = Order::where('uuid', $id)->first();
        View::response($this->indexFile, compact('title', 'context', 'user', 'id', 'order'));
    }
}