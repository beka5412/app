...
class MakePaymentController
{
    ...
    public function pay(Request $request)
    {
        ...
        // $cpf_cnpj = preg_replace('/\D/', '', sanitize($body->cpf_cnpj ?? ''));
        ...
        // $iugu_customer_id = $customer->iugu_customer_id;

        // if (!$customer->iugu_customer_id)
        // {
        //     $response = IuguRest::request(
        //         verb: 'POST',
        //         url: '/customers?api_token=' . env('IUGU_API_TOKEN'),
        //         headers: $headers,
        //         body: json_encode($payload),
        //         timeout: 10
        //     );

        //     $iugu_customer_id = $response->json->id ?? '';
        //     $customer->iugu_customer_id = $iugu_customer_id;
        //     $customer->save();
        // }
        ...
        // {
        //     $payload = [
        //         "plan_identifier" => $product->iugu_plan_id,
        ...
        //     $response = IuguRest::request(
        //         verb: 'POST',
        //         url: '/subscriptions?api_token=' . env('IUGU_API_TOKEN'),
        //         headers: $headers,
        //         body: json_encode($payload),
        //         timeout: 10
        //     );

        //     $iugu_subscription_id = $response->json->id ?? '';

        //     $order->iugu_subscription_id = $iugu_subscription_id;
        //     $order->save();
        // }
        ...
        // {
        //     $card_token = new CardToken;
        //     $card_token->token = $card_tokenized;
        //     $card_token->bin = substr($cc, 0, 6);
        //     $card_token->last_four_digits = substr($cc, -4);
        //     $card_token->year = $year;
        //     $card_token->month = $month;
        //     $card_token->user_id = $customer->user_id;
        //     $card_token->customer_id = $customer->id;
        //     $card_token->save();
        // }
